...
<body>
  ...
  <fieldset style="margin-bottom:7vh;">
    ...
    <form method="POST" style="margin-bottom:2vh;">
      <table>
        <tr>
          <td><input type="number" name="tinggi_sikir" placeholder="tinggi segitiga"></td>
        </tr>
        <tr>
          <td><input type="submit" name="submit_sikir" value="submit"></td>
        </tr>
      </table>
    </form>
    <?php
  ...
  <fieldset style="margin-bottom:7vh;">
    ...
    <form method="POST" style="margin-bottom:2vh;">
      <table>
        <tr>
          <td><input type="number" name="tinggi_sikan" placeholder="tinggi sikan"></td>
        </tr>
        <tr>
          <td><input type="submit" name="submit_sikan" value="submit"></td>
        </tr>
      </table>
    </form>
    <?php
