...
<html>
	...
	<body>
		...
		<div>
			<h1>Tugas Pokok dan Fungsi Unit Organisasi</h1>
			<h2></h2>
		</div>
		<br>
		<br>
				...
				<table class = "table">
					<tbody>
						...
						<tr>
							...
							<td> : </td>
							<td>
								<textarea type = "text" ID = "tugaspokok" name = "tugaspokok" placeholder = ""></textarea>
							</td>
						</tr>
						<tr>
							...
							<td> : </td>
							<td>
								<textarea type = "text" ID = "fungsi" name = "fungsi" placeholder = ""></textarea>
							</td>
						</tr>
					</tbody>
				</table>
